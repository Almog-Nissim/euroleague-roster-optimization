...
PRED_ALMOG = dict(
    placebo="מסכים עם קלוד",
    paired="**אולי אחד** מהגדלים יצא חיובי מול 12, לא כולם שליליים",
    verdict="המסקנה נשארת אותה מסקנה",
)
# ההבדל היחיד: קלוד אמר **כל** הגדלים שליליים. אלמוג נותן מקום
# לאחד חיובי. אם יצא בדיוק אחד — אלמוג.
# ====================================================================
...
# ⚠️ משוכפל מ-stochastic_avail **במכוון**, לא מיובא.
#    הקובץ נשמר אצל אלמוג תחת שם אחר וייבא את עצמו:
#      ImportError: cannot import name 'prune' from partially
#      initialized module 'stochastic_avail' (circular import)
#    סקריפט שמסקנה תלויה בו לא יסתמך על שם קובץ אחר.
