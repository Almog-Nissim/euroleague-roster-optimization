...
# 🔴 יום 15 — עוגן השחזור עודכן אחרי הריפיט של ADR 0001.
# לפני:  2.03  (מודל מחיר יחסי-מועדון, β₁=0.2317)
# אחרי:  5.10  (מודל שוק, β₁=0.1727)
# הערך אינו הצהרה על נכונות — הוא בקרת שחזור. עדכונו בלי לרשום
# את הישן לצידו היה מוחק את העדות לכך שהמספר זז, וזו בדיוק
# הסיבה שהבקרה קיימת.
# הרצה מקומית יום 15: 4.26 (אצל קלוד 5.10 — קובץ usage שונה))
BASE_HEADLINE = 4.26
N_BOOT = 4000
SEED = 13
# ====================================================================
