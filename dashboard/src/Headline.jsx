  ...
  return (
    <div dir="rtl" className="hl">
      ...
      <details className="card deep">
        ...
        <p className="sub">
          למנוע יש שני כללים שהוא לא יכול לעקוף. על המגרש יש כדור אחד, אז
          החמישה לא יכולים יחד לסיים יותר מ-100% מההתקפות. ואף שחקן לא מקבל
          יותר דקות ממה שקבוצות אמיתיות נתנו לכוכבים שלהן.
        </p>
