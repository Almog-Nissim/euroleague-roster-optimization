    ...
    <Shell>
      <header className="top">
        <div className="eyebrow">
          {d.benchmark.n} עונות־מועדון · כל הערכים בתוצאות שקרו בפועל
        </div>
      ...
      <section className="q">
        <div className="qh">
          ...
          <div>
            ...
            <p className="qs">
              כל נקודה היא מועדון. אופקי — התקציב שלו. אנכי — כמה
              המנוע הוסיף לו.
            </p>
          </div>
        </div>
        ...
        <p className="ans">
          ...
          {Math.abs(rr) < 0.3
            ...
            : rr < 0
              ? " ככל שהמועדון עשיר יותר, יש למנוע פחות מה להוסיף — הכסף כבר קנה את רוב מה שאפשר."
              : " דווקא למועדונים העשירים יש יותר מה להרוויח."}
          {" "}⚠️ זהו קשר בין מועדונים, לא ניסוי — מועדון עשיר שונה
          מעני גם בדברים שלא מדדנו.
        </p>
      </section>
      ...
      <footer>
        <b>המנוע</b> כאן הוא אותו מנוע של המסך הראשי: יש כדור אחד על
        הפרקט, ואף רוטציה לא מרוכזת בכוכבים יותר ממה שקבוצה אמיתית עשתה.
        המנוע נמדד על התוכנית שקבע מראש (שחקן שנפצע — הדקות שלו הולכות
        למחליף חלש), והקבוצה על מה ששיחקה בפועל.
      </footer>
    </Shell>
  );
}
