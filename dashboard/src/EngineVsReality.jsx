  ...
  return (
    <Shell>
      ...
      <footer>
        ...
        המגרש, ואף שחקן לא מקבל יותר דקות ממה שקבוצות אמיתיות נתנו לכוכבים
        שלהן. המנוע נמדד לפי התוכנית שקבע לפני העונה (כשמישהו נפצע, הדקות
        שלו הולכות למחליף חלש), והקבוצה לפי מה שהיא באמת שיחקה.
      </footer>
    </Shell>
  );
}
