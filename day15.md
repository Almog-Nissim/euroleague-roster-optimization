...
> as of 8661308; the committed CSVs above are authoritative.
>
> The "Blocking issue" section is resolved. "Next, in order" item 1 (step 1c) was
> run and reported falsified; its results file (`price_error_*.csv`) did not exist
> locally at 8661308 and is being regenerated. Item 2 (fatigue tiers) is
